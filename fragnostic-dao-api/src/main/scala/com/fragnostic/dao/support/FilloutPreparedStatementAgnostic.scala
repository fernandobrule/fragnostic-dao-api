...
trait FilloutPreparedStatementAgnostic extends DbTypesSupport {
  ...
  def filloutPsWithString =
    (prepStat: PreparedStatement, value: String) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.string.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.string.error")
  ...
  def filloutPsWithShort =
    (prepStat: PreparedStatement, value: Short) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.short.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.short.error")
  ...
  def filloutPsWithShortStrLng =
    (prepStat: PreparedStatement, req: (Short, String, Long)) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.short.string.long.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.short.string.long.error")
  ...
  def filloutPsWithInt =
    (prepStat: PreparedStatement, value: Int) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.int.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.int.error")
  ...
  def filloutPsWithIntInt =
    (prepStat: PreparedStatement, req: (Int, Int)) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.int.int.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.int.int.error")
  ...
  def filloutPsWithIntLong =
    (prepStat: PreparedStatement, req: (Int, Long)) =>
      try {
        ...
        case e: Exception =>
          logger.error(s"$e")
          Left("fillout.ps.with.int.long.error")
        case e: Throwable =>
          logger.error(s"$e")
          Left("fillout.ps.with.int.long.error")
      }
  ...
  def filloutPsWithLong =
    (prepStat: PreparedStatement, value: Long) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.error")
  ...
  def filloutPsWithLngShort =
    (prepStat: PreparedStatement, request: (Long, Short)) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.short.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.short.error")
  ...
  def filloutPsWithLngStr =
    (prepStat: PreparedStatement, request: (Long, String)) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.string.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.string.error")
  ...
  def filloutPsWithLngStrStr =
    (prepStat: PreparedStatement, request: (Long, String, String)) =>
      try {
        prepStat.setLong(1, request._1)
        prepStat.setString(2, request._2)
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.stringx2.string.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.stringx2.string.error")
  ...
  def filloutPsWithLngStrStrStr =
    (prepStat: PreparedStatement, request: (Long, String, String, String)) =>
      try {
        prepStat.setLong(1, request._1)
        prepStat.setString(2, request._2)
        prepStat.setString(3, request._3)
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.stringx3.string.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.stringx3.string.error")
  ...
  def filloutPsWithLngStrStrStrStr =
    (prepStat: PreparedStatement, request: (Long, String, String, String, String)) =>
      try {
        prepStat.setLong(1, request._1)
        prepStat.setString(2, request._2)
        prepStat.setString(3, request._3)
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.stringx4.string.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.stringx4.string.error")
  ...
  def filloutPsWithLngLng =
    (prepStat: PreparedStatement, request: (Long, Long)) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.long.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.long.error")
  ...
  def filloutPsWithLngLngStr =
    (prepStat: PreparedStatement, request: (Long, Long, String)) =>
      try {
        prepStat.setLong(1, request._1)
        prepStat.setLong(2, request._2)
        prepStat.setString(3, request._3)
  ...
  def filloutPsWithLngLngStrStr =
    (prepStat: PreparedStatement, request: (Long, Long, String, String)) =>
      try {
        prepStat.setLong(1, request._1)
        prepStat.setLong(2, request._2)
        prepStat.setString(3, request._3)
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.long.string.string.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.long.string.string,error")
  ...
  def filloutPsWithLngInt =
    (prepStat: PreparedStatement, request: (Long, Int)) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.int.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.long.int.error")
  ...
  def filloutPsWithStrLngStr =
    (prepStat: PreparedStatement, request: (String, Long, String)) =>
      try {
        ...
        case e: Exception => {
          logger.error(s"$e")
          Left("fillout.ps.with.string.long.string.error")
        }
        case e: Throwable => {
          logger.error(s"$e")
          Left("fillout.ps.with.string.long.string.error")
  ...
  def filloutPsWithStrLngLng =
    (prepStat: PreparedStatement, request: (String, Long, Long)) =>
      try {
        prepStat.setString(1, request._1)
        prepStat.setLong(2, request._2)
        ...
        case e: Exception => {
          ...
          Left("fillout.ps.with.string.long.long.error")
        }
        case e: Throwable => {
          logger.error(s"filloutPsWithStrLngLng | $e")
          Left("fillout.ps.with.string.long.long.error")
  ...
  def filloutPsWithStrStr =
    (prepStat: PreparedStatement, request: (String, String)) =>
      try {
        prepStat.setString(1, request._1)
        prepStat.setString(2, request._2)
        Right(prepStat)
        ...
        case e: Exception => {
          ...
          Left("fillout.ps.with.string.string.error.1")
        }
        case e: Throwable => {
          logger.error(s"filloutPsWithStrStr | $e")
          Left("fillout.ps.with.string.string.error.2")
        }
      }
    ...
    (prepStat: PreparedStatement, request: (String, Long)) =>
      try {
        ...
        case e: Exception => {
          ...
          Left("fillout.ps.with.string.long.error")
        }
        case e: Throwable => {
          logger.error(s"filloutPsWithStrLng | $e")
          Left("fillout.ps.with.string.long.error")
  ...
  def filloutPsWithBigDecLng =
    (prepStat: PreparedStatement, request: (BigDecimal, Long)) =>
      try {
        ...
        case e: Exception => {
          ...
          Left("fillout.ps.with.bigdecimal.long.error")
        }
        case e: Throwable => {
          logger.error(s"filloutPsWithBigDecLng | $e")
          Left("fillout.ps.with.bigdecimal.long.error")
  ...
  def filloutPsWithStrShortLng =
    (prepStat: PreparedStatement, request: (String, Short, Long)) =>
      try {
        prepStat.setString(1, request._1)
        prepStat.setShort(2, request._2)
        prepStat.setLong(3, request._3)
        ...
        case e: Exception => {
          ...
          Left("fillout.ps.with.string.short.long")
        }
        case e: Throwable => {
          logger.error(s"filloutPsWithStrShortLng | $e")
          Left("fillout.ps.with.string.short.long")
  ...
  def filloutPsWithLngBoolStrShortStr =
    (prepStat: PreparedStatement, request: (Long, Boolean, String, Short, String)) =>
      try {
        prepStat.setLong(1, request._1)
        ...
        case e: Exception =>
          logger.error(s"$e")
          Left("fillout.ps.with.long.boolean.string.short.string.error")
        case e: Throwable =>
          logger.error(s"$e")
          Left("fillout.ps.with.long.boolean.string.short.string,error")
      }
